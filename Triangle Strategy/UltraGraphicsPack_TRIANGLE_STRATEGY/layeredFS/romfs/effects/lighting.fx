# Enhanced Lighting Shader for TRIANGLE_STRATEGY

// PBR Lighting with enhanced effects for TRIANGLE_STRATEGY
...
// Enhanced specular calculation for TRIANGLE_STRATEGY
