# Enhanced Lighting Shader for DRAGON_QUEST_HEROES_2

// PBR Lighting with enhanced effects for DRAGON_QUEST_HEROES_2
...
// Enhanced specular calculation for DRAGON_QUEST_HEROES_2
