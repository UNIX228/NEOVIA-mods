# Enhanced Lighting Shader for DRAGON_QUEST_HEROES

// PBR Lighting with enhanced effects for DRAGON_QUEST_HEROES
...
// Enhanced specular calculation for DRAGON_QUEST_HEROES
