# Enhanced Lighting Shader for FINAL_FANTASY_VII

// PBR Lighting with enhanced effects for FINAL_FANTASY_VII
...
// Enhanced specular calculation for FINAL_FANTASY_VII
